<template>
<!--修改or新增用户组-->
<div :visible.sync="dialogShow" :before-close="update">
  <div class="popUpbig" STYLE="display: block">
    ...
    <div class="btnDiv">
      <button type="submit" class="btn btn-sm btn-info" @click="submitFrom(self, data.pid, 'Department/Create', 'Department/Edit', dept)">确定</button>
