    ...
    <div class="popContent">
      <el-form class="form-horizontal" :model="formData" ref="formData" :rules="rules">
        ...
        <div class="row">
          ...
          <div class="col-md-6" v-if="formData.type == 1">
            <div class="form-group">
              <label class="col-sm-4 control-label">绑定摄像头IP</label>
              <div class="col-sm-8">
                <table>
                  <tr v-for="(item,index) in formData.deviceVedios" :key="index">
                    <input type="text" class="form-control" placeholder="请输入IP1" v-model="item.vedioUrl" />
                  </tr>
                </table>
              </div>
            </div>
